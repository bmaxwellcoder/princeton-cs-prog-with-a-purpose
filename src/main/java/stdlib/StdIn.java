package stdlib; /******************************************************************************
 *  Compilation:  javac stdlib.StdIn.java
 *  Execution:    java stdlib.StdIn   (interactive test of basic functionality)
 *  Dependencies: none
 *
...
/**
 *  The {@code stdlib.StdIn} class provides static methods for reading strings
 ...
 *  <p>
 *  <b>Getting started.</b>
 *  To use this class, you must have {@code stdlib.StdIn.class} in your
 *  Java classpath. If you used our autoinstaller, you should be all set.
 *  Otherwise, either download
 *  <a href = "https://introcs.cs.princeton.edu/java/code/stdlib.jar">stdlib.jar</a>
 *  and add to your Java classpath or download
 *  <a href = "https://introcs.cs.princeton.edu/java/stdlib/StdIn.java">stdlib.StdIn.java</a>
 ...
 *      double value = stdlib.StdIn.readDouble();
 *      stdlib.StdOut.println(value);
 *  }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  while (stdlib.StdIn.hasNextChar()) {
 *      char c = stdlib.StdIn.readChar();
 *      stdlib.StdOut.print(c);
 *  }
 *  </pre>
 *  <p>
 ...
 *      String line = stdlib.StdIn.readLine();
 *      stdlib.StdOut.println(line);
 *  }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *  String[] words = stdlib.StdIn.readAllStrings();
 *  </pre>
 *  <p>
 *  <b>Differences with Scanner.</b>
 *  {@code stdlib.StdIn} and {@link Scanner} are both designed to parse
 *  tokens and convert them to primitive types and strings.
 *  The main differences are summarized below:
 *  <ul>
 *  <li> {@code stdlib.StdIn} is a set of static methods and reads
 ...
 *       and sockets.
 *  <li> {@code stdlib.StdIn} uses whitespace as the delimiter pattern
 *       that separates tokens.
 *       {@link Scanner} supports arbitrary delimiter patterns.
 *  <li> {@code stdlib.StdIn} coerces the character-set encoding to UTF-8,
 *       which is the most widely used character encoding for Unicode.
 *  <li> {@code stdlib.StdIn} coerces the locale to {@link Locale#US},
 *       for consistency with {@link StdOut}, {@link Double#parseDouble(String)},
 *       and floating-point literals.
 *  <li> {@code stdlib.StdIn} has convenient methods for reading a single
 *       character; reading in sequences of integers, doubles, or strings;
 *       and reading in all of the remaining input.
 *  </ul>
 *  <p>
 *  Historical note: {@code stdlib.StdIn} preceded {@code Scanner}; when
 ...
 *  Windows, and Linux.
 *  The methods in {@code stdlib.StdIn} are <em>blocking</em>, which means that they
 ...
 *  If the input begins with the optional byte-order mask, {@code stdlib.StdIn}
...
public final class StdIn {
    ...
    /*** begin: section (1 of 2) of code duplicated from In to stdlib.StdIn. */
    ...
    /*** end: section (1 of 2) of code duplicated from In to stdlib.StdIn. */
    ...
    //// begin: section (2 of 2) of code duplicated from In to stdlib.StdIn,
   ...
   /**
    ...
    //// end: section (2 of 2) of code duplicated from In to stdlib.StdIn

    // do this once when stdlib.StdIn is initialized
    static {
        resync();
    }

    /**
     * If stdlib.StdIn changes, use this to reinitialize the scanner.
     */
