...
/**
 *  The {@code stdlib.StdAudio} class provides static methods for
 ...
 *  <p>
 *  <b>Getting started.</b>
 *  To use this class, you must have {@code stdlib.StdAudio} in your Java classpath.
 ...
 *  provides access to {@code stdlib.StdAudio}.
 ...
 *  <li> Download <a href = "https://introcs.cs.princeton.edu/java/stdlib/StdAudio.java">stdlib.StdAudio.java</a>
 ...
 *           double freq = 440.0;
 *           for (int i = 0; i &lt; stdlib.StdAudio.SAMPLE_RATE; i++) {
 *               double sample = 0.5 * Math.sin(2 * Math.PI * freq * i / stdlib.StdAudio.SAMPLE_RATE);
 *               stdlib.StdAudio.play(sample);
 *           }
 *           stdlib.StdAudio.drain();
 *       }
 *   }
 *  </pre>
 *  <p>
 ...
 *  <pre>
 *   while (true) {
 *       stdlib.StdAudio.play("BassDrum.wav");
 *       stdlib.StdAudio.play("SnareDrum.wav");
 *   }
 *  </pre>
 *
 ...
 *  {@code stdlib.StdAudio} relies on the
 ...
 *  </ul>
 *  <p>
 *  When saving files, {@code stdlib.StdAudio} uses a sampling rate of 44,100 Hz,
 *  16 bits per sample, monaural audio, little endian, and linear PCM encoding.
 *  When reading files, {@code stdlib.StdAudio} converts to a sammpling rate of 44,100 Hz,
 ...
 *  <p>
 *  {@code stdlib.StdAudio} does not currently support recording audio that calls
