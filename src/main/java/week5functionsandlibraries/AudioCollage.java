package week5functionsandlibraries;

import stdlib.StdAudio;

/**
 * This class creates a library for manipulating digital audio and uses it to
 * create an audio collage. Sound is represented as an array of real numbers
 * between -1 and +1, with 44,100 samples per second. The library provides
 * functions to produce various audio effects by manipulating these arrays.
 * 
...
public class AudioCollage {
     ...
     * samples. This enables you to play two sounds sequentially.
     *
